...
export const NORM_REGISTRY: NormClause[] = [
  ...
  {
    id: 'sewer.pumps.selection',
    documentCode: 'СН РК 4.01-03-2013*',
    clause: '8.2.1',
    requirement:
      'Насосы, оборудование и трубопроводы следует выбирать в зависимости от расчётного притока и физико-химических свойств сточных вод или осадков, высоты подъёма',
    valueText: 'по притоку, свойствам стоков и высоте подъёма',
    units: '—',
    appliesSystem: SEWER_STORM,
    appliesWork: BOTH_WORK,
    status: 'verified',
  ...
  {
    id: 'sewer.pumps.standby',
    documentCode: 'СН РК 4.01-03-2013*',
    clause: '8.2.2',
    requirement:
      'Число резервных насосов по таблице 8.2. Бытовые стоки: 1–2 рабочих — 2 резервных (I категория), 1 (II и III); 3 и более — 2 (I и II), 1 и 1 на складе (III). Агрессивные стоки при всех категориях: 1 рабочий — 1 резервный и 1 на складе, 2–3 — 2, 4 — 3, 5 и более — не менее 50 %. Примечание 1: на станциях дождевых вод резерв, как правило, не требуется, кроме случаев, когда аварийный сброс невозможен. Примечание 3: для погружных насосов I категории допускается 1 резервный и 1 на складе, II категории — 1 резервный, независимо от числа рабочих',
    valueText: 'таблица 8.2',
    units: 'шт',
    appliesSystem: SEWER_STORM,
    appliesWork: BOTH_WORK,
    status: 'verified',
